...
public class getuserCurrentLocation extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
...
//        });
    ...
    private String geoLocate(String src){
        ...
        Geocoder geocoder = new Geocoder(getuserCurrentLocation.this);
...
//                Intent I = new Intent(getApplicationContext(),SendingFIlefromandroid.class);
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(getuserCurrentLocation.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(getuserCurrentLocation.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
...
//                mGoogleApiClient, mLocationRequest,this);
    ...
    protected synchronized void buildGoogleApiClient() {
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .addConnectionCallbacks(getuserCurrentLocation.this)
